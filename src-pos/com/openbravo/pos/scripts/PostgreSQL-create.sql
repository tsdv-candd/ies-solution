...
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('0', 'Vai Trò Q.Trị H.Thống', $FILE{/com/openbravo/pos/templates/Role.Administrator.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('1', 'Vai Trò Q.Lý C.Hàng', $FILE{/com/openbravo/pos/templates/Role.Manager.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('2', 'Vai Trò N.V Bán Lẻ', $FILE{/com/openbravo/pos/templates/Role.Employee.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('3', 'Vai Trò Khách', $FILE{/com/openbravo/pos/templates/Role.Guest.xml} );
INSERT INTO ROLES(ID, NAME, PERMISSIONS) VALUES('4', 'Vai Trò N.V Bán Sỉ', $FILE{/com/openbravo/pos/templates/Role.Employee.WholeSale.xml} );
...
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('0', 'Q.Trị H.Thống', NULL, '0', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('1', 'Q.Lý C.Hàng', NULL, '1', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('2', 'N.V Bán Lẻ', NULL, '2', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('3', 'Khách', NULL, '3', TRUE, NULL);
INSERT INTO PEOPLE(ID, NAME, APPPASSWORD, ROLE, VISIBLE, IMAGE) VALUES ('4', 'N.V Bán Sỉ', NULL, '4', TRUE, NULL);
...
CREATE TABLE CUSTOMERS (
    ...
    IMAGE BYTEA,
    CPOINT DOUBLE PRECISION DEFAULT 0 NOT NULL,
    CPOINTDATE TIMESTAMP,
    AWARD INTEGER DEFAULT 0 NOT NULL,
    AWDATE TIMESTAMP,
    PRIMARY KEY (ID),
...
INSERT INTO CATEGORIES(ID, NAME) VALUES ('000', 'Phân nhóm chính');
...
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('000', 'Miễn Thuế');
INSERT INTO TAXCATEGORIES(ID, NAME) VALUES ('001', 'Thuế GTGT');
...
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('000', 'Miễn Thuế', '000', NULL, NULL, 0, FALSE, NULL);
INSERT INTO TAXES(ID, NAME, CATEGORY, CUSTCATEGORY, PARENTID, RATE, RATECASCADE, RATEORDER) VALUES ('001', 'Thuế GTGT', '001', NULL, NULL, 0.10, FALSE, NULL);
...
CREATE TABLE PRODUCTS (
    ...
    PRICEWHOLESELL DOUBLE PRECISION DEFAULT 0 NOT NULL,
    PRIMARY KEY (ID),
...
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('1', 'Bàn 1', 80, 70, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('2', 'Bàn 2', 250, 75, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('3', 'Bàn 3', 400, 75, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('4', 'Bàn 4', 80, 200, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('5', 'Bàn 5', 260, 210, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('6', 'Bàn 6', 430, 210, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('7', 'Bàn 7', 80, 330, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('8', 'Bàn 8', 190, 350, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('9', 'Bàn 9', 295, 350, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('10', 'Bàn 10', 430, 345, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('11', 'Bàn 11', 550, 135, '0');
INSERT INTO PLACES(ID, NAME, X, Y, FLOOR) VALUES ('12', 'Bàn 12', 550, 290, '0');
