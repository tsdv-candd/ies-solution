 ...
 * @author adrianromero
 */
public class JPaymentCashPosDebt extends javax.swing.JPanel implements JPaymentInterface {
    ...
    public JPaymentCashPosDebt(JPaymentNotifier notifier, DataLogicSystem dlSystem) {
...
//        m_config=null;
    ...
    public PaymentInfo executePayment() {
        if (m_dPaid - m_dTotal >= 0.0) {
            // pago completo
            return new PaymentInfoCashDebt_original(m_dTotal, m_dPaid);
        } else {
            // pago parcial
            return new PaymentInfoCashDebt_original(m_dPaid, m_dPaid);
        }        
    }
    @Override
