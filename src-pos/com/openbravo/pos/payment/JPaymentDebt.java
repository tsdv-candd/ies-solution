...
public class JPaymentDebt extends javax.swing.JPanel implements JPaymentInterface {
    ...
    private void printState() {
        ...
        if (customerext == null) {
            ...
            //CanDDif (RoundUtils.compare(RoundUtils.getValue(customerext.getCurdebt()) + m_dPaid, RoundUtils.getValue(customerext.getMaxdebt())) >= 0) {
            if (RoundUtils.compare(RoundUtils.getValue(m_dTotal), RoundUtils.getValue(customerext.getMaxdebt())) >= 0) {
