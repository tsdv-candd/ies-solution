...
public class PaymentInfoCashPart_original extends PaymentInfo {
    ...
    public PaymentInfoCashPart_original(double dTotal, double dPaid) {
        m_dTotal = dTotal;
        m_dPaid = dPaid;
    }
    ...
    public String getName() {
        //return "cash";
        //return "Nợ Gối";
        return AppLocal.getIntString("transpayment.cashpart");
    }   
    @Override
