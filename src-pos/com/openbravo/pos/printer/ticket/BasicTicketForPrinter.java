...
public class BasicTicketForPrinter extends BasicTicket {
  ...
  //        private static int FONTHEIGHT = 14;
        private static Font BASEFONT = new Font("Monospaced", Font.TYPE1_FONT, 9).deriveFont(AffineTransform.getScaleInstance(1.0, 1.40));
        //private static Font BASEFONT = new Font("Arial", Font.PLAIN, 11).deriveFont(AffineTransform.getScaleInstance(1.0, 1.40));
