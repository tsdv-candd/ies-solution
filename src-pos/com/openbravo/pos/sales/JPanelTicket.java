...
public abstract class JPanelTicket extends JPanel implements JPanelView, BeanFactoryApp, TicketsEditor {
    ...
    //CanDD add customer payment dialog
    private JPaymentSelectCustomer paymentdialogcustomer;
...
// if the delay period is not zero create a inactivitylistener instance        
        ...
        //CanDD add customerpayment dialog
        paymentdialogcustomer = (JPaymentSelectCustomer) JPaymentSelectCustomer.getDialog(this);
...
// Added JDL change the startup state of addtax button
        ...
        if (m_App.getAppUserView().getUser().hasPermission("sales.WholeSale")) {
            ...
            if (m_jWholeSale.getSelectedItem().toString().equalsIgnoreCase("Bán Sỉ")) {
                m_isWholeSale = true;
            } else {
                m_isWholeSale = false;
            }
...
// Check if we have a warranty to print                         
            ...
            try {
                ...
                if (executeEvent(ticket, ticketext, "ticket.total") == null) {
                    ...
                    if(ticketType == TicketInfo.RECEIPT_NORMAL) {
                        paymentdialog = paymentdialogreceipt;
                    } else if (ticketType == TicketInfo.RECEIPT_PAYMENT) {
                        paymentdialog = paymentdialogcustomer;
                    } else {
...
// End mod
    ...
    private void initComponents() {
        ...
        m_jaddCurDebt.setText(bundle.getString("label.curdebt")); // NOI18N
        ...
        m_jaddCurDebt.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                m_jaddCurDebtActionPerformed(evt);
            }
        });
        ...
        m_jCurDebt.setPreferredSize(new java.awt.Dimension(80, 25));
...
// Autologoff after sending to kitchen   
    ...
    private void m_jaddCurDebtActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_m_jaddCurDebtActionPerformed
        //Test
//        AppView m_App = null;
